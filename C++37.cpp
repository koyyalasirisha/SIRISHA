...
int main(){
    ...
    cout<<"2.Character Expecption"<<endl;
    cout<<"3.String Expception"<<endl;
    cout<<"Enter choice:";
    cin>>choice;
    try{
    	if(choice==1){
			...
			throw string("This is a string exception");//string exception
		}
		else{
		...
		cout<<"Caught an string exception:"<<e<<endl;
	}
